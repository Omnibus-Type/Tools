...
![TypeProof — Headlines, light theme](https://github.com/Omnibus-Type/Tools/tree/organize/TypeProof/screenshots/headlines.png)
*Headlines view, light theme.*

![TypeProof — Hamburgefonstiv, dark theme](https://github.com/Omnibus-Type/Tools/tree/organize/TypeProof/screenshots/hamburg.png)
*Hamburg view, dark theme.*

![TypeProof — a–z A–Z 0–9](https://github.com/Omnibus-Type/Tools/tree/organize/TypeProof/screenshots/alphabet.png)
